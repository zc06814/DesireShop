...
if(isset($_GET["no"]))
{
    ...
    <div class="col-md-6 show text-right" style="width:50%; height:auto; min-width:40%;">  
        <div class="goods">
        <div><img src="image/Tshirt/<?php echo $no?>/1.jpg" /></div>
        </div>
    </div>
    <div class="col-md-6 show text-left" style="width:50%; height:auto; min-width:40%;">      
       ...
       <?php } ?>
        ...
        <div>產品說說明及注意事項</div>
        ＊深淺色請分開洗滌。</br>
        ＊印/繡花商品請反面放入細網洗衣袋中清洗，以保持商品型態。</br>
        ＊洗滌時，水溫請低於30 °C；請使用中性洗劑；請勿長時間浸泡。</br>
        ＊請勿使用漂白劑、螢光增白劑及衣物柔軟劑，以免破壞布料。</br>
        ＊不可濕放，以免衣物染色；請弱速輕脫水，不可烘乾，以免衣物縮水。</br>
        產地：中國&nbsp;&nbsp;材質：棉100%
    ...
    <div class="col-md-12">    
     <div class="goodshow">
    <img src="image/Tshirt/<?php echo $no?>/2.jpg"/>
    </div>
    <div class="goodshow">
    <img src="image/Tshirt/<?php echo $no?>/3.jpg" />
    </div>
    </div>
    </div>
...
<div class="row">
<div class="col-md-12">  
<img src="image/Tshirt/T.jpg" width="80%" style="margin:3% 10% 0 10%"/>
</div>
</div>

<div class="row" style="margin-left:10%; margin-right:10%">
<?php 
$sql = "Select DISTINCT id from item Where type='Tshirt'";
$result=$db->query($sql);
while($row=$result->fetch(PDO::FETCH_OBJ))
{
$id = $row->id;
...
?>
    ...
    <ul class="item-show01">
		<li><a href="Tshirt.php?no=<?php echo $id;?>">
		<img src="image/Tshirt/<?php echo $id;?>/1.jpg" alt="<?php echo $id;?>">
