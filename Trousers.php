...
if(isset($_GET["no"]))
{
    ...
    <div class="col-md-6 show text-right" style="width:50%; height:auto; min-width:40%;">  
        <div class="goods">
        <div><img src="image/Trousers/<?php echo $no?>/1.jpg" /></div>
        </div>
    </div>
    <div class="col-md-6 show text-left" style="width:50%; height:auto; min-width:40%;">      
      ...
      4.不可濕放，以免衣物染色；請弱速輕脫水，不可烘乾，以免衣物縮水。<br />
    </div>
        </div>
    </div>
    </div>    
    ...
    <div class="col-md-12">    
     <div class="goodshow">
    <img src="image/Trousers/<?php echo $no?>/2.jpg"/>
    </div>
    <div class="goodshow">
    <img src="image/Trousers/<?php echo $no?>/3.jpg" />
    </div>
    </div>
    </div>
...
<div class="row">
<div class="col-md-12">  
<img src="image/Trousers/T.jpg" width="80%" style="margin:3% 10% 0 10%"/>
</div>
</div>

<div class="row" style="margin-left:10%; margin-right:10%">
<?php 
$sql = "Select DISTINCT id from item Where type='Trousers'";
$result=$db->query($sql);
while($row=$result->fetch(PDO::FETCH_OBJ))
{
$id = $row->id;
...
?>
    ...
    <ul class="item-show01">
		<li><a href="Trousers.php?no=<?php echo $id;?>">
		<img src="image/Trousers/<?php echo $id;?>/1.jpg" alt="<?php echo $id;?>">
